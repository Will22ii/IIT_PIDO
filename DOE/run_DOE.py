...
def run_doe(*, config: DOEConfig, run_context: RunContext | None = None) -> dict:
    ...
    if config.user.use_additional:
        additional_cfg = {
            ...
            "phase2_gate1_rescue_enabled": config.system.phase2_gate1_rescue_enabled,
            "phase2_gate1_rescue_band": config.system.phase2_gate1_rescue_band,
            "phase2_gate1_rescue_gate2_min": config.system.phase2_gate1_rescue_gate2_min,
