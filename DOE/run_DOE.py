...
def run_doe(*, config: DOEConfig, run_context: RunContext | None = None) -> dict:
    ...
    if config.user.use_additional:
        additional_cfg = {
            ...
            "dynamic_exec_allocation_enabled": config.system.dynamic_exec_allocation_enabled,
            "exec_round_shares": list(config.system.additional_exec_round_shares),
            "exec_eff_weight_gate1": config.system.exec_eff_weight_gate1,
            "exec_eff_weight_gate2": config.system.exec_eff_weight_gate2,
            "exec_eff_gain_k": config.system.exec_eff_gain_k,
            "exec_eff_clip_min": config.system.exec_eff_clip_min,
