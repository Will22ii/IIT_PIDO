...
DEFAULT_ADDITIONAL_CFG = {
    "init_ratio": 0.4,
    "exec_ratio": 0.1,
    "dynamic_exec_allocation_enabled": True,
    "exec_round_shares": [0.24, 0.19, 0.17, 0.15, 0.13, 0.12],
    "exec_eff_weight_gate1": 0.45,
    "exec_eff_weight_gate2": 0.55,
    "exec_eff_gain_k": 0.7,
    "exec_eff_clip_min": 0.85,
    "exec_eff_clip_max": 1.20,
    "exec_stage_min_ratio": 0.08,
    "exec_stage_max_ratio": 0.40,
...
def run_doe_orchestrator(
    *,
    ...
    orchestrator = AdditionalDOEOrchestrator(
        ...
        dynamic_exec_allocation_enabled=cfg.get("dynamic_exec_allocation_enabled", True),
        exec_round_shares=cfg.get("exec_round_shares", [0.24, 0.19, 0.17, 0.15, 0.13, 0.12]),
        exec_eff_weight_gate1=cfg.get("exec_eff_weight_gate1", 0.45),
        exec_eff_weight_gate2=cfg.get("exec_eff_weight_gate2", 0.55),
        exec_eff_gain_k=cfg.get("exec_eff_gain_k", 0.7),
        exec_eff_clip_min=cfg.get("exec_eff_clip_min", 0.85),
        exec_eff_clip_max=cfg.get("exec_eff_clip_max", 1.20),
        exec_stage_min_ratio=cfg.get("exec_stage_min_ratio", 0.08),
        exec_stage_max_ratio=cfg.get("exec_stage_max_ratio", 0.40),
