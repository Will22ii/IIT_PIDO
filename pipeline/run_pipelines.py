...
def _extract_doe_router_metadata(doe_metadata_path: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "doe_additional_gp_x_scaling_enabled": _pick("additional_gp_x_scaling_enabled"),
        "doe_additional_gp_x_scaling_mode": _pick("additional_gp_x_scaling_mode"),
        "doe_additional_gp_x_scaling_auto_span_ratio_threshold": _pick("additional_gp_x_scaling_auto_span_ratio_threshold"),
        "doe_additional_gp_x_scaling_span_floor": _pick("additional_gp_x_scaling_span_floor"),
...
def _extract_explorer_router_metadata(explorer_metadata_path: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "explorer_gp_x_scaling_applied_pred": _pick("explorer_gp_x_scaling_applied_pred"),
        "explorer_gp_x_scaling_applied_obj": _pick("explorer_gp_x_scaling_applied_obj"),
        "explorer_gp_x_scaling_span_ratio_pred": _pick("explorer_gp_x_scaling_span_ratio_pred"),
        "explorer_gp_x_scaling_span_ratio_obj": _pick("explorer_gp_x_scaling_span_ratio_obj"),
        "explorer_gp_uncertainty_dim_weights": _pick("explorer_gp_uncertainty_dim_weights"),
    ...
    if detail_df.empty:
        detail_df = pd.DataFrame(
            columns=[
                ...
                "doe_usable_n",
                "doe_usable_n_over_p",
                "doe_additional_gp_x_scaling_enabled",
                "doe_additional_gp_x_scaling_mode",
                "doe_additional_gp_x_scaling_auto_span_ratio_threshold",
                "doe_additional_gp_x_scaling_span_floor",
                            ...
                            explorer_detail_rows.append(
                                {
                                    ...
                                    "doe_additional_gp_x_scaling_enabled": doe_meta_features.get("doe_additional_gp_x_scaling_enabled"),
                                    "doe_additional_gp_x_scaling_mode": doe_meta_features.get("doe_additional_gp_x_scaling_mode"),
                                    "doe_additional_gp_x_scaling_auto_span_ratio_threshold": doe_meta_features.get("doe_additional_gp_x_scaling_auto_span_ratio_threshold"),
                                    "doe_additional_gp_x_scaling_span_floor": doe_meta_features.get("doe_additional_gp_x_scaling_span_floor"),
                                    ...
                                    "explorer_gp_x_scaling_applied_pred": explorer_meta_features.get("explorer_gp_x_scaling_applied_pred"),
                                    "explorer_gp_x_scaling_applied_obj": explorer_meta_features.get("explorer_gp_x_scaling_applied_obj"),
                                    "explorer_gp_x_scaling_span_ratio_pred": explorer_meta_features.get("explorer_gp_x_scaling_span_ratio_pred"),
                                    "explorer_gp_x_scaling_span_ratio_obj": explorer_meta_features.get("explorer_gp_x_scaling_span_ratio_obj"),
                                    "explorer_gp_uncertainty_dim_weights": explorer_meta_features.get("explorer_gp_uncertainty_dim_weights"),
