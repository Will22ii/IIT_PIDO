...
def _write_focus3_debug_plots(
    *,
    ...
    trajectory_cols = [
        ...
        "focus3_near_goal_exploitation_enabled",
        "focus3_near_goal_exploitation_active",
        "focus3_near_goal_exploitation_reason",
        "focus3_near_goal_exploitation_threshold",
        "focus3_near_goal_exploitation_acq",
        "source_prob_topk",
        ...
        "focus3_random_refine_gate_enabled",
        "focus3_random_refine_gate_applied",
        "focus3_random_refine_gate_allowed",
        "focus3_random_refine_gate_reason",
        "focus3_random_refine_gate_margin",
        "focus3_random_refine_gate_random_score",
        "focus3_random_refine_gate_structured_best",
        "focus3_random_discrete_gate_enabled",
        "focus3_random_discrete_gate_applied",
        "focus3_random_discrete_gate_allowed",
        "focus3_random_discrete_gate_reason",
        "focus3_random_discrete_gate_margin",
        "focus3_random_discrete_gate_random_score",
        "focus3_random_discrete_gate_structured_best",
        "focus3_random_discrete_gate_recovery_active",
        "focus3_source_perf_applied",
        "focus3_source_perf_reason",
        "focus3_source_perf_recover_only",
        "focus3_source_perf_recovery_active",
        "focus3_source_perf_penalized_sources",
        "focus3_source_perf_best_plan_filter_applied",
        "focus3_source_perf_best_plan_filter_reason",
        "focus3_source_perf_best_plan_filter_penalized_sources",
        "focus3_source_perf_best_plan_filter_removable_sources",
        "focus3_source_perf_best_plan_filter_protected_source",
        "focus3_source_perf_best_plan_filter_protected_reason",
        "focus3_source_perf_best_plan_filter_near_goal_active",
        "focus3_source_perf_best_plan_filter_near_goal_threshold",
        "focus3_source_perf_best_plan_filter_removed_count",
        "focus3_source_perf_random_count",
        "focus3_source_perf_random_improved_count",
        "focus3_source_perf_random_improve_rate",
        "focus3_source_perf_local_probe_count",
        "focus3_source_perf_local_probe_improved_count",
        "focus3_source_perf_local_probe_improve_rate",
        "focus3_source_perf_boundary_count",
        "focus3_source_perf_boundary_improved_count",
        "focus3_source_perf_boundary_improve_rate",
        "focus3_source_perf_best_local_count",
        "focus3_source_perf_best_local_improve_rate",
        "focus3_source_perf_correlated_local_count",
        "focus3_source_perf_correlated_local_improve_rate",
        "focus3_source_perf_topk_count",
        "focus3_source_perf_topk_improve_rate",
        "focus3_source_perf_quota_random_before",
        "focus3_source_perf_quota_random_after",
        "focus3_source_perf_quota_shift_to_best_local",
        "focus3_source_perf_quota_shift_to_topk",
        "focus3_source_perf_quota_local_probe_before",
        "focus3_source_perf_quota_local_probe_after",
        "focus3_source_perf_quota_shift_local_probe_to_best_local",
        "focus3_source_perf_quota_shift_local_probe_to_topk",
        "focus3_source_perf_quota_boundary_before",
        "focus3_source_perf_quota_boundary_after",
        "focus3_source_perf_quota_shift_boundary_to_best_local",
        "focus3_source_perf_quota_shift_boundary_to_topk",
        ...
        "focus3_recover_best_local_applied",
        "focus3_recover_best_local_reason",
        "focus3_recover_best_local_bonus",
        "focus3_recover_best_local_late_active",
        "focus3_recover_best_local_max",
        "focus3_selected_best_local",
        "focus3_best_score_best_local",
        "focus3_selected_correlated_local",
        "focus3_best_score_correlated_local",
        "focus3_local_probe_active",
        "focus3_local_probe_reason",
        "focus3_local_probe_prob",
        "focus3_local_probe_performance_penalized",
        "focus3_selected_local_probe",
        "focus3_best_score_local_probe",
...
def build_focus_bo_region_output(bo_result: OptimizerAlgorithmResult) -> dict:
    focus_region_output = {}
    ...
    return focus_region_output


def build_focus_bo_final_bounds_payload(
    *,
    ...
    return final_bounds, final_info, payload


def write_focus_bo_meta_artifacts(
    *,
    meta_dir: str,
    bo_result: OptimizerAlgorithmResult,
    resolved: ResolvedOptimizerInputs,
    ...
    focus_region_output = build_focus_bo_region_output(bo_result)
    ...
    final_bounds, final_info, focus_bounds_payload = build_focus_bo_final_bounds_payload(
        bo_result=bo_result,
        resolved=resolved,
    )
    with open(focus_bounds_path, "w", encoding="utf-8") as f:
        json.dump(
            focus_bounds_payload,
            f,
            ensure_ascii=False,
            indent=2,
        )
    ...
    return {
        "focus_regions_path": focus_regions_path,
        "focus_bounds_path": focus_bounds_path,
        "focus_region_output": focus_region_output,
...
def write_focus_bo_debug_artifacts(
    *,
    debug_dir: str,
    history_df: pd.DataFrame,
    archive_df: pd.DataFrame,
    ...
    return {
        "focus2_debug_artifacts": focus2_debug_artifacts,
        "focus3_debug_artifacts": focus3_debug_artifacts,
        "focus2_plot_sec": float(focus2_plot_sec),
        "focus3_plot_sec": float(focus3_plot_sec),
    }
