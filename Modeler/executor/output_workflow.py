...
def save_modeler_outputs(
    *,
    ...
    resolved_params = {
        ...
        "objective_sense": str(raw_objective_sense),
        "raw_objective_sense": str(raw_objective_sense),
        "canonical_objective_sense": str(internal_objective_sense),
        "objective_transform": "negate" if str(raw_objective_sense).strip().lower() == "max" else "identity",
